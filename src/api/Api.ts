...
export interface UpdateHistoryStatusAdmin {
  /**
   * Status
   * @minLength 1
   */
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  calculations = {
    ...
    calculationsUpdateStatusAdminUpdate: (
      calculationId: string,
      data: UpdateHistoryStatusAdmin,
      params: RequestParams = {},
    ) =>
      this.request<UpdateHistoryStatusAdmin, any>({
  ...
  resistors = {
     ...
     * @secure
     */
    resistorsUpdateUpdate: (resistorId: string, data: Resistor, params: RequestParams = {}) =>
      this.request<Resistor, any>({
